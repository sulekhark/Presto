...
using System.Text;
using Microsoft.Cci;
using Daffodil.ExceptionFlowAnalysis.AnalysisNetBackend.ThreeAddressCode;
using Daffodil.ExceptionFlowAnalysis.AnalysisNetBackend.Utils;
...
namespace Daffodil.ExceptionFlowAnalysis.AnalysisNetBackend.Transformations
{
	public class Disassembler
	{
		...
		private void ProcessLoadConstant(BasicBlockInfo bb, IOperation op)
		{
			...
			bb.Instructions.Add(instruction);
            // System.Console.WriteLine("SRK_DBG: ProcessLoadConstant");
		}
		...
		private void ProcessLoadArgument(BasicBlockInfo bb, IOperation op)
		{
			...
			var instruction = new LoadInstruction(op.Offset, dest, source) { Location = GetSourceLocation(op.Location) };
			bb.Instructions.Add(instruction);
            // System.Console.WriteLine("SRK_DBG: ProcessLoadArgument");
        }
		...
		private void ProcessLoadArgumentAddress(BasicBlockInfo bb, IOperation op)
		{
			...
			var instruction = new LoadInstruction(op.Offset, dest, source) { Location = GetSourceLocation(op.Location) };
			bb.Instructions.Add(instruction);
            // System.Console.WriteLine("SRK_DBG: ProcessLoadArgumentAddress");
        }
		...
		private void ProcessLoadLocal(BasicBlockInfo bb, IOperation op)
		{
			...
			var instruction = new LoadInstruction(op.Offset, dest, source) { Location = GetSourceLocation(op.Location) };
			bb.Instructions.Add(instruction);
            // System.Console.WriteLine("SRK_DBG: ProcessLoadLocal");
        }
		...
		private void ProcessLoadLocalAddress(BasicBlockInfo bb, IOperation op)
		{
			...
			var instruction = new LoadInstruction(op.Offset, dest, source) { Location = GetSourceLocation(op.Location) };
			bb.Instructions.Add(instruction);
            // System.Console.WriteLine("SRK_DBG: ProcessLoadLocalAddress");
        }
		...
		private void ProcessLoadIndirect(BasicBlockInfo bb, IOperation op)
		{
			...
			var instruction = new LoadInstruction(op.Offset, dest, source) { Location = GetSourceLocation(op.Location) };
			bb.Instructions.Add(instruction);
            // System.Console.WriteLine("SRK_DBG: ProcessLoadIndirect");
        }
		...
		private void ProcessLoadInstanceField(BasicBlockInfo bb, IOperation op)
		{
			...
			var instruction = new LoadInstruction(op.Offset, dest, source) { Location = GetSourceLocation(op.Location) };
			bb.Instructions.Add(instruction);
            // System.Console.WriteLine("SRK_DBG: ProcessLoadInstanceField");
        }
		...
		private void ProcessLoadStaticField(BasicBlockInfo bb, IOperation op)
		{
			...
			var instruction = new LoadInstruction(op.Offset, dest, source) { Location = GetSourceLocation(op.Location) };
			bb.Instructions.Add(instruction);
            // System.Console.WriteLine("SRK_DBG: ProcessLoadStaticField");
        }
		...
		private void ProcessLoadInstanceFieldAddress(BasicBlockInfo bb, IOperation op)
		{
			...
			var instruction = new LoadInstruction(op.Offset, dest, source) { Location = GetSourceLocation(op.Location) };
			bb.Instructions.Add(instruction);
            // System.Console.WriteLine("SRK_DBG: ProcessLoadInstanceFieldAddress");
        }
		...
		private void ProcessLoadStaticFieldAddress(BasicBlockInfo bb, IOperation op)
		{
			...
			var instruction = new LoadInstruction(op.Offset, dest, source) { Location = GetSourceLocation(op.Location) };
			bb.Instructions.Add(instruction);
            // System.Console.WriteLine("SRK_DBG: ProcessLoadStaticFieldAddress");
        }
		...
		private void ProcessLoadArrayLength(BasicBlockInfo bb, IOperation op)
		{
			...
			bb.Instructions.Add(instruction);
            // System.Console.WriteLine("SRK_DBG: ProcessLoadArrayLength");
        }
		...
		private void ProcessLoadMultiArrayElement(BasicBlockInfo bb, IOperation op)
		{
			...
			var instruction = new LoadInstruction(op.Offset, dest, source) { Location = GetSourceLocation(op.Location) };
			bb.Instructions.Add(instruction);
            // System.Console.WriteLine("SRK_DBG: ProcessLoadMultiArrayElement");
        }
		...
		private void ProcessLoadArrayElement(BasicBlockInfo bb, IOperation op)
		{
			...
			var instruction = new LoadInstruction(op.Offset, dest, source) { Location = GetSourceLocation(op.Location) };
			bb.Instructions.Add(instruction);
            // System.Console.WriteLine("SRK_DBG: ProcessLoadArrayElement");
        }
		...
		private void ProcessLoadMultiArrayElementAddress(BasicBlockInfo bb, IOperation op)
		{
			...
			var instruction = new LoadInstruction(op.Offset, dest, source) { Location = GetSourceLocation(op.Location) };
			bb.Instructions.Add(instruction);
            // System.Console.WriteLine("SRK_DBG: ProcessLoadMultiArrayElementAddress");
        }
		...
		private void ProcessLoadArrayElementAddress(BasicBlockInfo bb, IOperation op)
		{
			...
			var instruction = new LoadInstruction(op.Offset, dest, source) { Location = GetSourceLocation(op.Location) };
			bb.Instructions.Add(instruction);
            // System.Console.WriteLine("SRK_DBG: ProcessLoadArrayElementAddress");
        }
		...
		private void ProcessLoadMethodAddress(BasicBlockInfo bb, IOperation op)
		{
			...
			var instruction = new LoadInstruction(op.Offset, dest, source) { Location = GetSourceLocation(op.Location) };
			bb.Instructions.Add(instruction);
            // System.Console.WriteLine("SRK_DBG: ProcessLoadMethodAddress");
        }
		...
		private void ProcessLoadVirtualMethodAddress(BasicBlockInfo bb, IOperation op)
		{
			...
			var instruction = new LoadInstruction(op.Offset, dest, source) { Location = GetSourceLocation(op.Location) };
			bb.Instructions.Add(instruction);
            // System.Console.WriteLine("SRK_DBG: ProcessLoadVirtualMethodAddress");
        }
		...
		private void ProcessLoadToken(BasicBlockInfo bb, IOperation op)
		{
			...
			bb.Instructions.Add(instruction);
            // System.Console.WriteLine("SRK_DBG: ProcessLoadToken");
        }
