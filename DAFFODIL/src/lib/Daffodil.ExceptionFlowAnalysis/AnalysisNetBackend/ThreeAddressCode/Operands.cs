...
using Daffodil.ExceptionFlowAnalysis.AnalysisNetBackend.ThreeAddressCode.Expressions;

namespace Daffodil.ExceptionFlowAnalysis.AnalysisNetBackend.ThreeAddressCode.Values
{
	...
	public class StaticMethodReference : IFunctionReference
	{
		...
		{
			get { return Daffodil.ExceptionFlowAnalysis.AnalysisNetBackend.Types.Instance.FunctionPointerType(this.Method); }
		}
	...
	public class ArrayLengthAccess : IFieldAccess
	{
		...
		public ITypeReference Type
		{
			get { return Daffodil.ExceptionFlowAnalysis.AnalysisNetBackend.Types.Instance.ArrayLengthType; }
		}
	...
	public class ArrayElementAccess : IAssignableValue, IReferenceable, IExpression
	{
		...
		public ITypeReference Type
		{
			get { return Daffodil.ExceptionFlowAnalysis.AnalysisNetBackend.Types.Instance.ArrayElementType(this.Array.Type); }
		}
	...
	public class Dereference : IAssignableValue, IReferenceable, IExpression
	{
		...
		public ITypeReference Type
		{
			get { return Daffodil.ExceptionFlowAnalysis.AnalysisNetBackend.Types.Instance.PointerTargetType(this.Reference.Type); }
		}
	...
	public class Reference : IValue, IExpression
	{
		...
		public ITypeReference Type
		{
			get { return Daffodil.ExceptionFlowAnalysis.AnalysisNetBackend.Types.Instance.PointerType(this.Value.Type); }
		}
